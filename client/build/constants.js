  ...
  var oim = {
    ...
    system: {
      api: {
        ...
        endpoints: {
          actter:'@@urlActter',
          wcfCWVI: '@@apiWcfCWVI',
          wcfCuestionario: '@@apiWcfCuestionario',
          security: "@@urlSecurity",
          policy: "@@urlPolicy",
          policies: {
            suscripcionSalud: '@@urlPolicies.urlSuscripcionSalud'
          },
          camposanto: {
            url: '@@camposanto.url',
            username: '@@camposanto.username',
            password: '@@camposanto.password',
            token: '@@camposanto.token',
          },
          orchestrator: '@@urlOrchestrator',
          nsctr: '@@urlNsctr',
          ...
          enel: '@@urlEnel',
          webproc: '@@urlWebProc',
          adminPortal: "@@urlAdminPortal",
          seguridad: '@@urlSeguridad',
          inspec: '@@urlInspec',
          callerDash: '@@urlCallerDash',
          restos: '@@urlRestos',
          referencia: '@@urlReferencia',
          referencias : '@@urlReferencias',
          gper: '@@urlGPer',
          medicalCenter: '@@urlMedicalCenter',
          seguroviaje: '@@urlseguroViaje',
          reembolso: "@@urlReembolso",
          reembolso2: "@@urlReembolso2",
          mydream: '@@urlMyDream',
          kpissalud : '@@urlKpissalud',
          farmapfre : '@@urlFarmapfre',
          paymentgateway: '@@urlPaymentgateway',
          sctrDenuncia:"@@urlSctrDenuncia",
          atencionsiniestrosagricola : '@@urlAtencionsiniestrosagricola',
          wsrgenerardocumento: '@@urlWsrgenerardocumento', //MSAAVEDRA 20211112
          wsrRegistrarReticenciaAuto: '@@urlWsrRegistrarReticenciaAuto'
        }
      },
      login: {
    ...
    ORIGIN_SYSTEMS: {
      ...
      myDream: {
        ...
        url: '@@urlMyDreamDeploy',
        home: '@@urlMyDreamDeploy' + 'home',
        logout: '@@urlMyDreamDeploy' + '?logout=',
      },
      selfService: {
        code: 'AUWEB',
        title: '',
        icon: '',
        bodyClass: '',
        url: '@@urlSelfServiceBase',
        home: '@@urlSelfServiceBase' + '#/home',
        logout: '@@urlSelfServiceBase' + '#/login?logout=',
        apps: '@@urlSelfServiceBase' + '#/apps',
      }
    },
    STORAGE_KEYS: {
      profile: 'profile',
