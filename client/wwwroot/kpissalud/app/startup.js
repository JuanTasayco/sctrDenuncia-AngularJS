...
(function($window, p) {
  ...
  require(['system', 'sys'], function(system, sys) {
    system.currentApp = !system.apps.kpissalud ? sys.app: system.apps.kpissalud;
    system.import([
        system.lib.package,
        sys.app,
        system.apps.home
      ...
      function(mainPackage, mcPackage) {
        require([mainPackage.lib.constants.name], function(){
          require([
            ...
            mcPackage.lib.appKpissalud.name,
          ],
          function(ng) {
            ng.element($window.document).ready(function() {
              ng.bootstrap($window.document, ['kpissalud.app', function() {
