(function ($root, deps, action) {
  ...
  function (ng
    ...
    appSecurity.controller('crearUsuarioCorredor03Controller',
      ['$scope'
        , '$state'
        , '$timeout'
        , 'seguridadFactory'
        , function ($scope
          ...
          (function onLoad() {
            ...
            if (!$scope.create.validStep1)
              ...
              $state.go('crearUsuarioCorredor.steps', { step: 2 });
            else {
              ...
              $scope.typeUser = $scope.createS2.corredor.mTipoUsuario; //Ejecutivo Mapfre : Administrador
