(function($root, deps, action){
  ...
  'nsctrModalReniecListJs'
    ...
    appNsctr.controller('lifeLawReplacePayrollController',
      ...
      nsctrFactory, $stateParams, mainServices, nsctrService, $filter, $location, $anchorScroll){
        ...
        # fnShowPayroll
        ########################*/
        function _paramsIndividualLoad(tabPayroll,ShowInsured){
        ...
        function _paramsMassiveLoad(tabPayroll,ShowInsured){
          var vParamsIndividualLoad = JSON.stringify(_paramsIndividualLoad(tabPayroll,ShowInsured)),
        ...
        function _paramsShowPayroll(tabPayroll,ShowInsured){
          var vParams = ($scope.data.TYPE_LOAD.individual.code == tabPayroll)
                          ? _paramsIndividualLoad(tabPayroll,ShowInsured)
                          : _paramsMassiveLoad(tabPayroll,ShowInsured);
          return vParams;
        }
        ...
        function _showPayroll(data){
          ...
          $scope.data.riskInsuredList = data.riskInsuredList;
        ...
        $scope.fnShowPayroll = function(){
          ...
          if (_validateForm(vTabPayroll)){
            var vParams = _paramsShowPayroll(vTabPayroll,ShowInsured);
