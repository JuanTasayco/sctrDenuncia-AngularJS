...
define([], function() {
  return {
    ...
    ngAddBannerModule: 'appAP.AddBannerFactory',
    ngSecurityModule: 'appAP.SecurityFactory',
    ngMassMaintenanceModule: 'appAP.MassMaintenanceFactory',
