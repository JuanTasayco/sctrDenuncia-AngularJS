...
!(function(e, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ? t(exports)
    : 'function' == typeof define && define.amd ? define(['exports'], t) : t((e.reduxLogger = e.reduxLogger || {}));
})(this, function(e) {
  'use strict';
  function t(e, t) {
    (e.super_ = t),
        ...
        : null === e
          ...
          : Array.isArray(e)
            ...
            : '[object Date]' === Object.prototype.toString.call(e)
              ? 'date'
              : 'function' == typeof e.toString && /^\/.*\//.test(e.toString()) ? 'regexp' : 'object';
  }
  ...
  function x(e, t) {
    ...
    e.forEach(function(o, s) {
      ...
      try {
        k
          ? f.title && c ? r.groupCollapsed.apply(r, ['%c ' + O].concat(A)) : r.groupCollapsed(O)
          : f.title && c ? r.group.apply(r, ['%c ' + O].concat(A)) : r.group(O);
      } catch (e) {
        r.log(O);
      }
  ...
  var k,
    ...
    D = function(e) {
      return (
        A(e.getHours(), 2) + ':' + A(e.getMinutes(), 2) + ':' + A(e.getSeconds(), 2) + '.' + A(e.getMilliseconds(), 3)
      );
    },
    O =
    ...
    C = [];
  (k =
    'object' === ('undefined' == typeof global ? 'undefined' : N(global)) && global
      ? global
