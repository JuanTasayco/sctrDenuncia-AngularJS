...
define(['angular', 'lodash'], function (ng, _) {
  ReGastosSepelioGridController.$inject = ['reServices'];

  function ReGastosSepelioGridController(reServices) {
    var vm = this;
    vm.$onInit = onInit;
  ...
  return ng
    .module('appReembolso')
    .controller('ReGastosSepelioGridController', ReGastosSepelioGridController)
    .component('reGastosSepelioGrid', {
      templateUrl: '/reembolso/app/components/solicitud/steps/coverages/coverage-grid/gastos-sepelio-grid/gastos-sepelio-grid.html',
      controller: 'ReGastosSepelioGridController as $ctrl',
      bindings: {
        edit: '<?',
        delete: '<?',
        comprobantesList: '<',
