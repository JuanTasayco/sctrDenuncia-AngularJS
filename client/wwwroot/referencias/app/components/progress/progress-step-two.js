...
})(window, "progressStepTwo", ["angular"], function (angular) {
  angular
    .module("referencias.app")
    .controller("progressStepTwoController", [
      "$scope",
      "$timeout",
      "mpSpin",
      "proxyFiltro",
    ...
    .component("progressStepTwo", {
      templateUrl:
        "/referencias/app/components/progress/progress-step-two.html",
      controller: "progressStepTwoController",
      bindings: {
        step: "=?",
        provedor: "=?",
