...
(function($root, deps, action){
    ...
    module.constant('oimProxyGrqc', {
     ...
     module.factory("proxyLookup", ['oimProxyGrqc', 'httpData', function(oimProxyGrqc, httpData){
        return {
                'Resource_CGW_Get_ListState' : function( showSpin){
                    return httpData['get'](oimProxyGrqc.endpoint + 'api/cgw/getState',
                                         undefined, undefined, showSpin)
                },
                'GetVersion' : function( showSpin){
                    return httpData['get'](oimProxyGrqc.endpoint + 'api/cgw/getVersion',
                                         undefined, undefined, showSpin)
                }
        };
     }]);
     ...
     module.factory("proxyGeneral", ['oimProxyGrqc', 'httpData', function(oimProxyGrqc, httpData){
        return {
                ...
                'Resource_General_Wcf_EnviarEmail' : function(body, showSpin){
                    return httpData['post'](oimProxyGrqc.endpoint + 'api/general/wcfEnviaEmail',
     ...
     module.factory("proxyClient", ['oimProxyGrqc', 'httpData', function(oimProxyGrqc, httpData){
        return {
                ...
                'ExclusionesTemporales' : function(exclusiones, showSpin){
                    return httpData['post'](oimProxyGrqc.endpoint + 'api/client/listaExclusionesTemporales',
     ...
     module.factory("proxyGuaranteeLetter", ['oimProxyGrqc', 'httpData', function(oimProxyGrqc, httpData){
        return {
                'AttachedDocumentSave' : function( showSpin){
                    return httpData['post'](oimProxyGrqc.endpoint + 'api/guaranteeletter',
                                         undefined, undefined, showSpin)
                },
                'GetListAttachedDocument' : function(year, number, version, showSpin){
                    return httpData['get'](oimProxyGrqc.endpoint + helper.formatNamed('api/guaranteeletter?year={year}&number={number}&version={version}',
                ...
                'Resource_AttachedDocumentRejection_Update' : function(id, documentId, request, showSpin){
                    return httpData['put'](oimProxyGrqc.endpoint + helper.formatNamed('api/guaranteeletter/{id}/document/{documentId}',
                ...
                'Resource_AttachedDocumentRejection_get' : function(year, id, version, documentId, showSpin){
                    return httpData['get'](oimProxyGrqc.endpoint + helper.formatNamed('api/guaranteeletter/{id}/document/{documentId}?year={year}&version={version}',
                ...
                'Resource_GuaranteeLetter_Complaint_ReasonReject' : function( showSpin){
                    return httpData['get'](oimProxyGrqc.endpoint + 'api/guaranteeletter/complaint/reasonreject',
                                         undefined, undefined, showSpin)
                },
                'Resource_GuaranteeLetter_Complaint_ReasonFinalized' : function( showSpin){
                    return httpData['get'](oimProxyGrqc.endpoint + 'api/guaranteeletter/complaint/reasonfinalized',
                                         undefined, undefined, showSpin)
                },
                'Resource_GuaranteeLetter_Complaint_Required' : function(companyId, providerId, productId, showSpin){
                    return httpData['get'](oimProxyGrqc.endpoint + helper.formatNamed('api/guaranteeletter/complaintRequired?companyId={companyId}&providerId={providerId}&productId={productId}',
                ...
                'Resource_GuaranteeLetter_Send_Mail_Invalidez' : function(body, year, number, version, showSpin){
                    return httpData['post'](oimProxyGrqc.endpoint + helper.formatNamed('api/guaranteeletter/sendMailInvalidez?year={year}&number={number}&version={version}',
                                                    { 'year':  { value: year, defaultValue:'' } ,'number':  { value: number, defaultValue:'' } ,'version':  { value: version, defaultValue:'' }  }),
                                         body, undefined, showSpin)
                }
        };
     ...
     module.factory("proxyClinic", ['oimProxyGrqc', 'httpData', function(oimProxyGrqc, httpData){
        return {
                'Resource_Clinic_Get_ListClinic' : function(year, number, showSpin){
                    return httpData['get'](oimProxyGrqc.endpoint + helper.formatNamed('api/clinic/clinics?year={year}&number={number}',
     ...
     module.factory("proxyCgwSecurity", ['oimProxyGrqc', 'httpData', function(oimProxyGrqc, httpData){
        return {
