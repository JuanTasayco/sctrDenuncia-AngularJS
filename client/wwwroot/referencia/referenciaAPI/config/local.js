...
module.exports = {
  ...
  // ssl: {
  //   key: require('fs').readFileSync(__dirname + '/certs/server.key'),
  //   cert: require('fs').readFileSync(__dirname + '/certs/server.crt')
  // },
...
//     cert: require('fs').readFileSync(__dirname + '/certs/server.crt')
//   };
//   local.port = 8443; // This port should be different than your default port
// }
