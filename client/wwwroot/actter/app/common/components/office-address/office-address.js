define(['angular', 'system', 'generalConstant', 'actterFactory'], function (angular, system, generalConstant) {
  officeAddressController.$inject = ['$scope', 'actterFactory', 'mpSpin'];
  function officeAddressController($scope, actterFactory, mpSpin) {
    var vm = this;
  ...
  return angular
    ...
    .controller('officeAddressController', officeAddressController)
    .component('officeAddress', {
      templateUrl: system.apps.actter.location + '/app/common/components/office-address/office-address.html',
      controller: 'officeAddressController as vm',
      bindings: {
        form: '=',
        paramsForm: '=',
        countries: '='
