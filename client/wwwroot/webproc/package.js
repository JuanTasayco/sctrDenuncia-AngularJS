...
define([], function() {
  return {
    ...
    shim: {
      ...
      detalleAsistenciaPageController: {
        deps: ['wpCabeceraAsistencia', 'wpConstant', 'mpfTimepicker', 'wpCommonCbos', 'wpLugarOcurrencia','wpTerceroConvenio','wpFixedAsistencia','wpPersonComponent','wpVehiculoSoat']
      },
      wpTerceroConvenio: {
