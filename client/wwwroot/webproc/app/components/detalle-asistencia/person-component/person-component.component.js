...
define(['angular', 'lodash', 'AsistenciaActions', 'wpConstant'], function (ng, _, AsistenciaActions, wpConstant) {
  PersonComponentController.$inject = ['wpFactory', '$log', '$scope', '$interval', '$ngRedux', 'mainServices','$timeout', '$rootScope'];
  function PersonComponentController(wpFactory, $log, $scope, $interval, $ngRedux, mainServices, $timeout, $rootScope) {
    var vm = this
    var onFrmSave;
    vm.$onInit = onInit;
    ...
    function setConductor(data) {
      ...
      vm.frmConductor.fchNacimientoConductor = null;
