(function($root, deps, action){
  ...
  appAutos.controller('hogarDocController',
    ...
    }]).factory('loaderQuoteHogarDocumentsController', ['documentosFactory', '$q', 'hogarFactory', function(documentosFactory, $q, hogarFactory){
      var products;
      //Products
