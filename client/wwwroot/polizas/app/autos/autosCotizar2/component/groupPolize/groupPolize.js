...
define([
	...
	appAutos.controller('ctrlGroupPolize', ['$scope', '$window', '$state', 'autosCotizarFactory', 'mpSpin', function($scope, $window, $state, autosCotizarFactory, mpSpin){
		...
		_self.searchGroupPolize = function(groupPolize){
			...
			if ((typeof groupPolize !== 'undefined') && groupPolize != ''){
				autosCotizarFactory.getPolizaGrupoNombre(groupPolize).then(function(response){
		...
		templateUrl: '/polizas/app/autos/autosCotizar2/component/groupPolize/groupPolize.html',
