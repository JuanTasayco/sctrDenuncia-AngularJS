...
define(['angular'], function(ng) {
	SeguroviajeCotizarStepsController.$inject = [
		'$scope',
		'$rootScope'
	];
	function SeguroviajeCotizarStepsController($scope, $rootScope) {
		var vm = this;
	...
	return ng.module('appSeguroviaje')
		.controller('SeguroviajeCotizarStepsController', SeguroviajeCotizarStepsController)
});
