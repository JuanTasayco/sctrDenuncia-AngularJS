(function($root, deps, action){
	...
	'/polizas/app/vida/proxy/vidaFactory.js', 'decesoFactory'],
	function(angular, constants, helper, _){

		var appAutos = angular.module('appDeceso');

		appAutos.controller('decesoPendingQuotesController',
			['$scope', '$window', '$state', '$timeout', 'vidaFactory', 'decesoFactory', 'oimClaims', 'oimPrincipal', 'vidaProducts', 'vidaRoles', 'decesoAuthorize', 
			function($scope, $window, $state, $timeout, vidaFactory, decesoFactory, oimClaims, oimPrincipal, vidaProducts, vidaRoles, decesoAuthorize){
				(function onLoad(){
