...
function(angular, constants, helper, _){
  ...
  appAutos.controller('decesoEmittedQuotesController',
    ['$scope', '$window', '$state', '$timeout', 'decesoFactory', 'vidaFactory', 'oimClaims', 'oimPrincipal', 'vidaProducts', 'vidaRoles', 'decesoAuthorize',
    function($scope, $window, $state, $timeout, decesoFactory, vidaFactory, oimClaims, oimPrincipal, vidaProducts, vidaRoles, decesoAuthorize){
      (function onLoad(){
      ...
      $scope.link = function(item) {
        ...
        $state.go('cotizacionGuardadaDeceso', {
          numDoc: item.NumeroCotizacion
        });
      };
      ...
      function _buildGestor(value){
        var data = {
          ...
          CodigoOficina: (true) ? '0' : oimClaims.officeCode, //'9999', //pendiente en el claims o por CONFIRMar, pero si el rol es admin valor 0
      ...
      $scope.searchGestor = function(value){
        ...
        return decesoFactory.getGestor(params, false);
      }
      /*########################
      # autocompleteAgent
      ########################*/
      ...
      $scope.searchAgent = function(value){
        ...
        return decesoFactory.getAgent(params, false);
      }
      function _showAgent(){
      ...
      function _buildFilter(currentPage){
        ...
        var data = {
          ...
          Agente: {
            ...
            CodigoOficina: 		(true) ? '0' : oimClaims.officeCode, //'0' //0 //pendiente en el claims o por CONFIRMar, pero si el rol es admin valor 0
          },
          CantidadFilasPorPagina: '10',
          PaginaActual: 					currentPage,
          IndicadorConsulta: "PROV" //'1'
        }
        return data;
      }
