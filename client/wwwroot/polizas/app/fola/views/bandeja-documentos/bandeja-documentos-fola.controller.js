define(['angular', 'constants'], function (angular, constants) {
  ...
  angular
    ...
    .controller('bandejaDocumentosFolaController', BandejaDocumentosFolaController);

  BandejaDocumentosFolaController.$inject = ['$scope','$state', 'folaService', 'mpSpin'];
  function BandejaDocumentosFolaController($scope,$state, folaService, mpSpin) {
    var vm = this;
    // Propiedades
    vm.pagination = {
      currentPage: 1,
    ...
    function _setRequestBuscarDocumentos(filtros) {
      vm.parametrosReporte = {
        ...
        numeroPoliza: (filtros && filtros.numeroPoliza) || '',
