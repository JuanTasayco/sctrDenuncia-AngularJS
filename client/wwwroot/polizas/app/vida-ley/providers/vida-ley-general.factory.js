define([
  ...
  angular
    ...
    .factory('vidaLeyGeneralFactory', VidaLeyGeneralFactory);

  VidaLeyGeneralFactory.$inject = [];

  function VidaLeyGeneralFactory() {
    var factory = {
    ...
    function GetHtmlTablaError(errores, isIndividual, observacion) {
      ...
      var vHtml = '<div class="row">'
        ...
        + '<li class="col-sm-2 col-ms-2 col-xs-3 clearfix cnt-item g-text-center-xs"><b>' + labelFila + '</b></li>'
